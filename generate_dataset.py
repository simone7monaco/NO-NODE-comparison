...
if __name__ == "__main__":
    ...
    np.save(outdir / 'loc_train' + suffix + '.npy', loc_train)
    np.save(outdir / 'vel_train' + suffix + '.npy', vel_train)
    np.save(outdir / 'edges_train' + suffix + '.npy', edges_train)
    np.save(outdir / 'charges_train' + suffix + '.npy', charges_train)

    np.save(outdir / 'loc_valid' + suffix + '.npy', loc_valid)
    np.save(outdir / 'vel_valid' + suffix + '.npy', vel_valid)
    np.save(outdir / 'edges_valid' + suffix + '.npy', edges_valid)
    np.save(outdir / 'charges_valid' + suffix + '.npy', charges_valid)

    np.save(outdir / 'loc_test' + suffix + '.npy', loc_test)
    np.save(outdir / 'vel_test' + suffix + '.npy', vel_test)
    np.save(outdir / 'edges_test' + suffix + '.npy', edges_test)
    np.save(outdir / 'charges_test' + suffix + '.npy', charges_test)
