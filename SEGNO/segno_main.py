...
if __name__ == "__main__":
    ...
    # Data parameters
    parser.add_argument('--dataset', type=str, default="charged",
                        help='Data set')
    parser.add_argument('--root', type=str, default="datasets",
                        help='Data set location')
    parser.add_argument('--download', type=bool, default=False,
                        help='Download flag')
    parser.add_argument('--target', type=str, default="short",
                        help='Target interval[short, medium, long]')
    parser.add_argument('--data_path', type=str, default="/home/smonaco/NO-NODE-comparison/data")
    parser.add_argument('--dataset_size', type=str, default="small",
                        help='dataset_size [small, medium, large]')
    ...
    wandb.init(project="Particle-Physics", entity="jet-tagging", config=args, 
               mode="online" if args.use_wb else "disabled")
    ...
    if args.dataset == "charged":
        ...
        raise NotImplementedError("Gravity dataset is not implemented yet")
